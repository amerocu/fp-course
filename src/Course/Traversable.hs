...
instance (Functor f, Functor g) =>
  ...
  (<$>) f (Product fa ga) = Product fb gb where
    fb = f <$> fa
    gb = f <$> ga
...
-- Implement the traverse function for a Traversable instance for Product
  traverse f (Product fa ga) = lift2 Product afb agb where
    afb = traverse f fa
    agb = traverse f ga
...
-- Implement the traverse function for a Traversable instance for Coproduct
  traverse f (InL fa) = lift1 InL $ traverse f fa
  traverse f (InR ga) = lift1 InR $ traverse f ga
